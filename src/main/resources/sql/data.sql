INSERT IGNORE INTO LANGUAGE (LOCALE, MESSAGE_KEY, MESSAGE_CONTENT) VALUES
     ...
     ('en', 'email_duplication','This email already exists'),
     ('ko', 'email_duplication','이미 존재하는 이메일입니다')
;
